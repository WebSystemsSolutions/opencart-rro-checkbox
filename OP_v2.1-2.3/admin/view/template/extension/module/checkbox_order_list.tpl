...
<script>
    $(document).ready(function () {
        ...
        $(document).on('click', '#button-checkbox-rro-order-list-container, .checkbox-rro-order-list-button-refresh', function () {
            ...
            $.get('index.php?route=extension/module/checkbox/orderListContainer&token=<?php echo $token; ?>', function(html) {
        ...
        $(document).on('click', '.js-checkbox-rro-order-create-shift', function () {
            ...
            $.get('index.php?route=extension/module/checkbox/createCashierShift&token=<?php echo $token; ?>', function(html) {
        ...
        $(document).on('click', '.js-checkbox-rro-order-close-shift', function () {
            ...
            $.get('index.php?route=extension/module/checkbox/closeCashierShift&token=<?php echo $token; ?>', function(html) {
        ...
        $(document).on('click', '.checkbox-rro-order-list-button-service-cash', function () {
            ...
            $.get('index.php?route=extension/module/checkbox/createServiceReceipt&token=<?php echo $token; ?>&cash=' + cash, function(html) {
