    ...
    <script>
        $(document).ready(function () {
            ...
            $(document).on('click', '#checkbox-rro-order-info-button-create-receipt', function () {
                ...
                $.get('index.php?route=extension/module/checkbox/createReceipt&order_id=<?= $order_id ?>&payment_type=' + payment_type + '&send_email=' + send_email + '&token=<?= $token; ?>', function (html) {
