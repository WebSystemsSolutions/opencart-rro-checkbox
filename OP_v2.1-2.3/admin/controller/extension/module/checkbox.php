...
class ControllerExtensionModuleCheckbox extends Controller
{
    ...
    public function index()
    {
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('extension/module/checkbox', 'token=' . $this->session->data['token'], true)
        );

        $data['action'] = $this->url->link('extension/module/checkbox', 'token=' . $this->session->data['token'], true);
        ...
        if (version_compare(VERSION, '3.0', '>=')) {
            ...
            $this->response->setOutput($this->load->view('extension/module/checkbox.tpl', $data));
        }
    }
    ...
    public function getViewInfo()
    {
        ...
        if (version_compare(VERSION, '3.0', '>=')) {
            ...
            return $this->load->view('extension/module/checkbox_order_info.tpl', $data);
        }
    ...
    public function getViewList()
    {
        ...
        if (version_compare(VERSION, '3.0', '>=')) {
            ...
            return $this->load->view('extension/module/checkbox_order_list.tpl', $data);
        }
    ...
    public function orderInfo()
    {
        ...
        $data['link_html_receipt'] = $this->url->link('extension/module/checkbox/getReceiptHtml', 'token=' . $token . '&receipt_id=' . $order_info['checkbox_receipt_id'], true);
        $data['link_html_receipt_return'] = $this->url->link('extension/module/checkbox/getReceiptHtml', 'token=' . $token . '&receipt_id=' . $order_info['checkbox_return_receipt_id'], true);
        ...
        if (version_compare(VERSION, '3.0', '>=')) {
            ...
            $this->response->setOutput($this->load->view('extension/module/checkbox_order_info_ajax.tpl', $data));
        }
    ...
    public function orderListContainer()
    {
        ...
        $data['link_z_report'] = $this->url->link('extension/module/checkbox/getZReport', 'token=' . $token, true);
        ...
        if (version_compare(VERSION, '3.0', '>=')) {
            ...
            $this->response->setOutput($this->load->view('extension/module/checkbox_order_list_ajax.tpl', $data));
        }
