...
class ModelExtensionPaymentCheckbox extends Model
{
    ...
    public function __construct($registry)
    {
        ...
        $this->login = $this->config->get('module_checkbox_rro_login');
        $this->password = $this->config->get('module_checkbox_rro_password');
        $this->cashbox_key = $this->config->get('module_checkbox_rro_cashbox_key');
        $this->is_dev = $this->config->get('module_checkbox_rro_is_dev');
        $this->getBearToken();
    }
